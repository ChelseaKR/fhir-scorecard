...
| Federal marketplace frame (national) | CMS/CCIIO **QHP Landscape PY2026 Individual Medical**: every issuer selling an individual-market QHP on HealthCare.gov, in every federally-facilitated-exchange state. 30 states, 176 state-issuer organizations, 183 HIOS issuer IDs, 97,082 plan-county rows; the per-issuer roster is committed at `data/frames/qhp-landscape-py2026-individual-medical.csv` | 2026-08-19 | Reviewed a state at a time. Twenty states reviewed so far: Texas and Florida (15 organizations each), Wisconsin (12), Ohio (11), Arizona, Michigan, Missouri and Oklahoma (7 each), Iowa, Kansas, Louisiana and North Carolina (6 each), Indiana, Mississippi and Nebraska (5 each), Alabama (4), Delaware (3), Alaska, West Virginia and Wyoming (2 each), each at its own `/<state>-marketplace/` page; the other 10 states' 43 state-issuer organizations are **not yet reviewed**, which is a statement about this project's progress and never about what those issuers publish |
...
the frame's coverage arithmetic (20 of 30 states, 133 of 176 state-issuer organizations reviewed)
