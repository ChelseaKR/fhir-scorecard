...
| Federal marketplace frame (national) | CMS/CCIIO **QHP Landscape PY2026 Individual Medical**: every issuer selling an individual-market QHP on HealthCare.gov, in every federally-facilitated-exchange state. 30 states, 176 state-issuer organizations, 183 HIOS issuer IDs, 97,082 plan-county rows; the per-issuer roster is committed at `data/frames/qhp-landscape-py2026-individual-medical.csv` | 2026-08-19 | Reviewed a state at a time. Twelve states reviewed so far: Texas and Florida (15 organizations each), Ohio (11), Wisconsin (12), Arizona, Michigan, Missouri and Oklahoma (7 each), Iowa, Kansas, Louisiana and North Carolina (6 each), each at its own `/<state>-marketplace/` page; the other 18 states' 71 state-issuer organizations are **not yet reviewed**, which is a statement about this project's progress and never about what those issuers publish |
...
the frame's coverage arithmetic (12 of 30 states, 105 of 176 state-issuer organizations reviewed)
